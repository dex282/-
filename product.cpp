...
void Product::printFull() const {
    ...
    switch(supplier) {
        case Supplier::SUPPLIER_A: std::cout << "The supplier А"; break;
        case Supplier::SUPPLIER_B: std::cout << "The supplier Б"; break;
        case Supplier::SUPPLIER_C: std::cout << "The supplier В"; break;
